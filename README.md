...
- **Historia** — logi wszystkich operacji (VBN check, VBN fix, product create, photo upload, sync, Auto VBN) z nazwą użytkownika, rozwijalnymi szczegółami i paginacją.
...
components  ──SSE────────▶  /vbn-check/stream                 products
            ...
            ──POST───────▶  /photo-upload/execute             vbn_auto_log
...
| `admin:manage` | Panel admina, synchronizacja, debug |
...
src/
  app/
    page.tsx                      — hub z kafelkami + nawigacja + language switcher
...
| `FRESHPORTAL_URL` | **TAK** | URL FreshPortal, np. `https://fp042100.freshportal.nl` |
| `FRESHPORTAL_USERNAME` | **TAK** | Login FreshPortal |
| `FRESHPORTAL_PASSWORD` | **TAK** | Hasło FreshPortal |
...
| `/sync/run` | POST | `admin:manage` | Uruchom synchronizację |
