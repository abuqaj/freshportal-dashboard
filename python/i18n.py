...
MSGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "create_checking_copy":   "Checking name and number in the product database…",
    ...
    "nl": {
        ...
        "create_checking_copy":   "Naam en nummer controleren in de productdatabase…",
    ...
    "pl": {
        ...
        "create_checking_copy":   "Sprawdzam nazwę i numer w bazie produktów…",
    ...
    "es": {
        ...
        "create_checking_copy":   "Comprobando nombre y número en la base de productos…",
