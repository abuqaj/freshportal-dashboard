...
MSGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "create_waiting_lock":    "Another product is being created — waiting for it to finish…",
        "create_checking_list":            "Checking the name and number in the product list…",
        "export_downloading":              "Downloading the product list from the export API…",
        "export_downloading_background":   "Product list is being downloaded in the background — reading FreshPortal this time…",
        "export_using_stale":              "Using the product list downloaded {minutes} min ago; refreshing in the background…",
        "export_loaded":                   "Product list ready — {count} products",
        "export_failed":                   "Could not read the product export ({error}) — reading FreshPortal instead",
        "create_checking_number": "Checking in FreshPortal that number {num} is free…",
        "create_checking_name":   "Checking in FreshPortal that the name is not in use…",
        "create_reading_back":    "Checking the filled-in form…",
        "create_verify_retry":    "Product not visible yet — checking again ({attempt}/{total})…",
        ...
        "vbn_analyzing_product": "Analyzing product {i}/{total}…",
    ...
    "nl": {
        ...
        "create_waiting_lock":    "Er wordt al een ander product aangemaakt — wachten tot dat klaar is…",
        "create_checking_list":            "Naam en nummer controleren in de productlijst…",
        "export_downloading":              "Productlijst downloaden via de export-API…",
        "export_downloading_background":   "Productlijst wordt op de achtergrond gedownload — deze keer via FreshPortal…",
        "export_using_stale":              "Productlijst van {minutes} min geleden in gebruik; wordt op de achtergrond ververs…",
        "export_loaded":                   "Productlijst klaar — {count} producten",
        "export_failed":                   "Kon de productexport niet lezen ({error}) — FreshPortal wordt gelezen",
        "create_checking_number": "In FreshPortal controleren of nummer {num} vrij is…",
        "create_checking_name":   "In FreshPortal controleren of de naam nog niet bestaat…",
        "create_reading_back":    "Ingevuld formulier controleren…",
        "create_verify_retry":    "Product nog niet zichtbaar — opnieuw controleren ({attempt}/{total})…",
        ...
        "vbn_analyzing_product": "Product {i}/{total} analyseren…",
    ...
    "pl": {
        ...
        "create_waiting_lock":    "Trwa tworzenie innego produktu — czekam, aż się zakończy…",
        "create_checking_list":            "Sprawdzam nazwę i numer na liście produktów…",
        "export_downloading":              "Pobieram listę produktów z export API…",
        "export_downloading_background":   "Lista produktów pobiera się w tle — tym razem czytam FreshPortal…",
        "export_using_stale":              "Używam listy produktów pobranej {minutes} min temu; odświeżam w tle…",
        "export_loaded":                   "Lista produktów gotowa — {count} produktów",
        "export_failed":                   "Nie udało się odczytać eksportu produktów ({error}) — czytam FreshPortal",
        "create_checking_number": "Sprawdzam w FreshPortal, czy numer {num} jest wolny…",
        "create_checking_name":   "Sprawdzam w FreshPortal, czy nazwa nie jest zajęta…",
        "create_reading_back":    "Sprawdzam wypełniony formularz…",
        "create_verify_retry":    "Produktu jeszcze nie widać — sprawdzam ponownie ({attempt}/{total})…",
        ...
        "vbn_analyzing_product": "Analiza produktu {i}/{total}…",
    ...
    "es": {
        ...
        "create_waiting_lock":    "Se está creando otro producto — esperando a que termine…",
        "create_checking_list":            "Comprobando el nombre y el número en la lista de productos…",
        "export_downloading":              "Descargando la lista de productos desde la API de exportación…",
        "export_downloading_background":   "La lista de productos se descarga en segundo plano — esta vez se lee FreshPortal…",
        "export_using_stale":              "Se usa la lista descargada hace {minutes} min; se actualiza en segundo plano…",
        "export_loaded":                   "Lista de productos lista — {count} productos",
        "export_failed":                   "No se pudo leer la exportación de productos ({error}) — se lee FreshPortal",
        "create_checking_number": "Comprobando en FreshPortal que el número {num} está libre…",
        "create_checking_name":   "Comprobando en FreshPortal que el nombre no existe…",
        "create_reading_back":    "Comprobando el formulario rellenado…",
        "create_verify_retry":    "El producto aún no aparece — comprobando de nuevo ({attempt}/{total})…",
        ...
        "vbn_analyzing_product": "Analizando producto {i}/{total}…",
