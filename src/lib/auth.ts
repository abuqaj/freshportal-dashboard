...
import { getUserByUsername, verifyPassword, isAccountLocked, recordFailedLogin, clearFailedAttempts, recordLastLogin } from "./auth-db"
  ...
  providers: [
    Credentials({
      ...
      async authorize(credentials) {
        ...
        await recordLastLogin(username)
